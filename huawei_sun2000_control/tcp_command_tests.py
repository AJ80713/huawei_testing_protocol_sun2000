...
if __name__ == "__main__":
    asyncio.run(main())
# Example usage script for the battery control functions.
# It connects over TCP, runs a charge/discharge cycle and then
# cleanly disconnects. The script uses asyncio.run() and can be
# extended with additional test cases as needed.
